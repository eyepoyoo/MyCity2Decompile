Shader "Custom/GUI/Circle Ring Textured X4 1" {
Properties {
...
"!!GLES
					...
					void main ()
					{
					  ...
					  tmpvar_13 = ((vec2(1.0, 1.0) - abs(xlv_TEXCOORD1)) * _ClipArgs0);
					  col_3.w = (col_3.w * clamp (min (tmpvar_13.x, tmpvar_13.y), 0.0, 1.0));
					  tmpvar_1 = col_3;
