...
public class ScreenCutsceneCrookRoundup : ScreenBase
{
	private const float ANIM_DUR = 2.5f;
	...
	protected override void OnShowScreen()
	{
		...
		SoundFacade._pInstance.PlayOneShotSFX("CutsceneCrookRoundup", 0f);
		base.OnShowScreen();
