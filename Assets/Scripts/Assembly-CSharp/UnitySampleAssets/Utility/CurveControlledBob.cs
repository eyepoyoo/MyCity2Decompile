...
namespace UnitySampleAssets.Utility
{
	...
	public class CurveControlledBob
	{
		...
		{
			float x = _originalCameraPosition.x + Bobcurve.Evaluate(_cyclePositionX) * HorizontalBobRange;
			float y = _originalCameraPosition.y + Bobcurve.Evaluate(_cyclePositionY) * VerticalBobRange;
