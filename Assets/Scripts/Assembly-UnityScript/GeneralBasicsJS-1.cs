...
[Serializable]
public class GeneralBasicsJS_00201 : MonoBehaviour
{
	...
	internal void _0024advancedExamples_0024closure_002411()
	{
		for (int i = 0; i < 10; i++)
		{
			GameObject gameObject = new GameObject("rotator" + i);
	...
	internal LTDescr _0024_0024advancedExamples_0024closure_002411_0024closure_002412(GameObject rot)
	{
		return LeanTween.rotateAround(rot, Vector3.forward, -1080f, 12f);
	}

	internal void _0024_0024advancedExamples_0024closure_002411_0024closure_002413(GameObject rot)
	{
		UnityEngine.Object.Destroy(rot);
	}
}
