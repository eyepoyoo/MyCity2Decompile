...
namespace Prime31
{
	...
	public abstract class AbstractManager : MonoBehaviour
	{
		...
		public static void createThreadingCallbackHelper()
		{
			...
			AbstractManager._threadingCallbackHelper = global::UnityEngine.Object.FindObjectOfType(typeof(ThreadingCallbackHelper)) as ThreadingCallbackHelper;
			if (AbstractManager._threadingCallbackHelper != null)
			{
				return;
			}
		...
		public static GameObject getPrime31ManagerGameObject()
		{
			...
			if (AbstractManager._prime31GameObject == null)
			{
				...
				global::UnityEngine.Object.DontDestroyOnLoad(AbstractManager._prime31GameObject);
			}
			return AbstractManager._prime31GameObject;
		}
		...
		public static void initialize(Type type)
		{
			try
			{
				MonoBehaviour monoBehaviour = global::UnityEngine.Object.FindObjectOfType(type) as MonoBehaviour;
			...
			{
				Debug.LogWarning(string.Concat(new object[] { "It looks like you have the ", type, " on a GameObject in your scene. Our new prefab-less manager system does not require the ", type, " to be on a GameObject.\nIt will be added to your scene at runtime automatically for you. Please remove the script from your scene." }));
			}
		}
