Shader "Custom/City/No Curve Vac Legacy Special Boat Render 2" {
Properties {
...
SubShader { 
 LOD 300
 Tags { "RenderType"="Opaque" "RenderQueue"="Geometry+2" }
 Pass {
  Name "FORWARD"
  Tags { "LIGHTMODE"="ForwardBase" "SHADOWSUPPORT"="true" "RenderType"="Opaque" "RenderQueue"="Geometry+2" }
  GpuProgramID 61788
Program "vp" {
SubProgram "gles " {
Keywords { "DIRECTIONAL" "SHADOWS_OFF" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" }
					...
					void main ()
					{
					  ...
					  c_13.w = c_14.w;
					  c_13.xyz = (c_14.xyz + (tmpvar_10 * xlv_TEXCOORD3));
					  c_3.xyz = c_13.xyz;
					  c_3.w = 1.0;
					  gl_FragData[0] = c_3;
					}
...
Keywords { "DIRECTIONAL" "SHADOWS_SCREEN" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" }
					...
					void main ()
					{
					  ...
					  tmpvar_23 = (pow (nh_18, y_22) * tmpvar_12.w);
					  c_17.xyz = (((tmpvar_11 * tmpvar_14) * diff_19) + ((tmpvar_14 * _SpecColor.xyz) * tmpvar_23));
					  c_17.w = (tmpvar_12.w * _Color.w);
					  c_16.w = c_17.w;
					  c_16.xyz = (c_17.xyz + (tmpvar_11 * xlv_TEXCOORD3));
					  c_4.xyz = c_16.xyz;
					  c_4.w = 1.0;
					  gl_FragData[0] = c_4;
					}
...
Keywords { "DIRECTIONAL" "SHADOWS_SCREEN" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" "FOG_LINEAR" }
					...
					void main ()
					{
					  ...
					  c_4.xyz = mix (unity_FogColor.xyz, c_16.xyz, vec3(tmpvar_24));
					  c_4.w = 1.0;
					  gl_FragData[0] = c_4;
					}
...
Keywords { "DIRECTIONAL" "SHADOWS_SCREEN" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" "FOG_LINEAR" }
 ...
 Pass {
  Name "FORWARD"
  Tags { "LIGHTMODE"="ForwardAdd" "RenderType"="Opaque" "RenderQueue"="Geometry+2" }
  ZWrite Off
  Blend One One
  GpuProgramID 89005
Program "vp" {
...
Keywords { "DIRECTIONAL" "FOG_LINEAR" }
					...
					void main ()
					{
					  ...
					  highp float tmpvar_19;
					  tmpvar_19 = (pow (nh_14, y_18) * tmpvar_11.w);
					  c_13.xyz = (((tmpvar_10 * tmpvar_1) * diff_15) + ((tmpvar_1 * _SpecColor.xyz) * tmpvar_19));
					  c_13.w = (tmpvar_11.w * _Color.w);
					  highp float tmpvar_20;
					  tmpvar_20 = clamp (xlv_TEXCOORD4, 0.0, 1.0);
					  c_3.xyz = (c_13.xyz * vec3(tmpvar_20));
					  c_3.w = 1.0;
					  gl_FragData[0] = c_3;
					}
...
Keywords { "SPOT" "FOG_LINEAR" }
					...
					void main ()
					{
					  ...
					  c_23.xyz = (((tmpvar_12 * tmpvar_1) * diff_25) + ((tmpvar_1 * _SpecColor.xyz) * tmpvar_29));
					  c_23.w = (tmpvar_13.w * _Color.w);
					  highp float tmpvar_30;
					  tmpvar_30 = clamp (xlv_TEXCOORD4, 0.0, 1.0);
					  c_3.xyz = (c_23.xyz * vec3(tmpvar_30));
					  c_3.w = 1.0;
					  gl_FragData[0] = c_3;
					}
...
Keywords { "DIRECTIONAL_COOKIE" "FOG_LINEAR" }
 ...
 Pass {
  Name "PREPASS"
  Tags { "LIGHTMODE"="PrePassBase" "RenderType"="Opaque" "RenderQueue"="Geometry+2" }
  GpuProgramID 170169
Program "vp" {
SubProgram "gles " {
"!!GLES
...
"!!GLES"
 ...
 Pass {
  Name "PREPASS"
  Tags { "LIGHTMODE"="PrePassFinal" "RenderType"="Opaque" "RenderQueue"="Geometry+2" }
  ZWrite Off
  GpuProgramID 221530
Program "vp" {
SubProgram "gles " {
Keywords { "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" "HDR_LIGHT_PREPASS_OFF" }
					...
					void main ()
					{
					  ...
					  tmpvar_10 = (light_3.w * tmpvar_6.w);
					  spec_9 = tmpvar_10;
					  c_8.xyz = ((tmpvar_5 * light_3.xyz) + ((light_3.xyz * _SpecColor.xyz) * spec_9));
...
Keywords { "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" "UNITY_HDR_ON" }
					...
					void main ()
					{
					  ...
					  tmpvar_11 = (tmpvar_8.w * tmpvar_6.w);
					  spec_10 = tmpvar_11;
...
Keywords { "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" "FOG_LINEAR" "UNITY_HDR_ON" }
 ...
 Pass {
  Name "DEFERRED"
  Tags { "LIGHTMODE"="Deferred" "RenderType"="Opaque" "RenderQueue"="Geometry+2" }
  GpuProgramID 296149
Program "vp" {
SubProgram "gles " {
Keywords { "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" "HDR_LIGHT_PREPASS_OFF" }
					...
					void main ()
					{
					  ...
					  emission_8.xyz = (emission_8.xyz + (tmpvar_5 * xlv_TEXCOORD4));
...
Keywords { "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" "UNITY_HDR_ON" }
					...
					void main ()
					{
					  ...
					  emission_7.xyz = (emission_7.xyz + (tmpvar_4 * xlv_TEXCOORD4));
